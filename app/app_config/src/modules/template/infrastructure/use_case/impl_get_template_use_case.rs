...
use crate::{
    modules::template::domain::use_case::get_template_use_case::{
        GetTemplatesUseCase, GetTemplatesUseCasePublic,
    },
    try_get_surreal_pool,
};

#[async_trait::async_trait]
impl GetTemplatesUseCasePublic for GetTemplatesUseCase {
    async fn execute(
